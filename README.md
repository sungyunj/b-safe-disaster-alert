...
| 재난 단계 | VU | 총 요청 | 성공률 | 실패 | 평균 응답시간 | P95 | 최대 응답시간 | VM-A | VM-B |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| **평상시** | 10 | 590 | 100% | 0 | 31.15ms | 35.87ms | 56.71ms | 590 | 0 |
| **주의보** | 50 | 2,945 | 100% | 0 | 33.07ms | 37.83ms | 1.07s | 1,120 | 1,825 |
| **태풍 경보** | 100 | 5,843 | 100% | 0 | 34.44ms | 50.97ms | 1.11s | 2,743 | 3,100 |
